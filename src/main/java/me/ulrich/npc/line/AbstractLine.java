...
public abstract class AbstractLine<T> {
    ...
    public AbstractLine(@NotNull Collection<Player> seeingPlayers, @NotNull Plugin plugin, int entityID, @NotNull T obj, EntityEquipData equipData, EntityPoseData poseData, EntityEnum entityType, AgeType age) {
        this.plugin = plugin;
