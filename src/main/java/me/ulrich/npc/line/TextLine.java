...
public class TextLine extends AbstractLine<String> {
    ...
    public TextLine(@NotNull Collection<Player> seeingPlayers, @NotNull Plugin plugin, int entityID, @NotNull String obj, EntityEquipData equipData, EntityPoseData poseData, EntityEnum entityType, AgeType age) {
        super(seeingPlayers, plugin, entityID, obj, equipData, poseData, entityType, age);
        ...
        if(VersionUtil.isCompatible(VersionUtil.VersionEnum.V1_8)) {
          ...
          //baseplate|hands
            ...
            if(VersionUtil.isAbove(VersionEnum.V1_13)) {
            	Optional<?> opt = Optional.of(WrappedChatComponent.fromChatMessage(this.obj)[0].getHandle());
            	...
            	watcher.setObject(new WrappedDataWatcher.WrappedDataWatcherObject(2, WrappedDataWatcher.Registry.get(String.class)), this.obj);
            }
    ...
    public void update(@NotNull Player player) throws NullPointerException {
    	...
    	if(((this.getEquipData()!=null) && (this.getEquipData().getHead()==null && this.getEquipData().getChest()==null && this.getEquipData().getLegs()==null && this.getEquipData().getBoots()==null && this.getEquipData().getMainHand()==null && this.getEquipData().getOffHand()==null))) {
